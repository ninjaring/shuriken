...
Class PageData {
  ...
  static function create_asset_collections($page) {
    ...
    # page.images
    $page->images = Helpers::list_files($page->file_path, '/(?<!thumb|_lge|_sml|_\w..)\.(gif|jpg|png|jpeg)$/i', false);
    # page.numbered_images
    $page->numbered_images = Helpers::list_files($page->file_path, '/^\d+[^\/]*(?<!thumb|_lge|_sml|_\w..)\.(gif|jpg|png|jpeg)$/i', false);
    # page.video
    $page->video = Helpers::list_files($page->file_path, '/\.(mov|mp4|m4v)$/i', false);
    # page.previewset, added by ninjaring for urbandiningrat
    $page->previewset = Helpers::list_files($page->file_path, '/^_\w{3}\.(gif|jpg|png|jpeg)$/i', false);
